...
def _build_full_transcript_prompt(*, title: str, url: str, transcript_text: str, language: str) -> str:
    return (
        ...
        "Do not invent facts, topics, or quotes.\n"
        "Return JSON that matches the schema.\n"
        "Keep the summary concise and factual.\n"
        "Keywords must be short noun phrases.\n"
        "Highlights must be representative excerpts copied or lightly trimmed from the transcript.\n"
        f"Video title: {title}\n"
        f"Video URL: {url}\n"
...
def _build_chunk_prompt(
    *,
    ...
    return (
        ...
        "Do not invent facts.\n"
        "Return JSON that matches the schema.\n"
        "Provide up to 3 summary points, up to 8 keywords, and up to 3 representative excerpts.\n"
        "Highlights must be copied or lightly trimmed from the transcript chunk.\n"
        f"Video title: {title}\n"
